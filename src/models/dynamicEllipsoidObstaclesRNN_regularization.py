...
class Decoder(tfkl.Layer):
    def __init__(self, rnn_state_size_lstm_concat = 512, fc_hidden_unit_size = 256, reg_factor = 0.01):
        ...
        #     kernel_regularizer = tfkr.l2(self.reg_factor), recurrent_regularizer = tfkr.l2(self.reg_factor), bias_regularizer = tfkr.l2(self.reg_factor), activity_regularizer = tfkr.l2(self.reg_factor)) , merge_mode = 'ave')
